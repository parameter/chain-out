...
function populateBadgeForm(badge) {
    ...
    // Handle requiresWeatherAPI checkbox
    const requiresWeatherAPICheckbox = document.getElementById('requiresWeatherAPI');
...
async function toggleDoneStatus(index) {
    ...
    try {
        ...
        // Update the local badge data after successful save
