...
const searchForEarnedBadges = async ({ scorecardId, results, courseId, layout, scorecard }) => {  
  ...
  console.log('perPlayerEarned 1', util.inspect(perPlayerEarned, false, null, true /* enable colors */));
  ...
  if (bulkOps.length > 0) {
    ...
    console.log('failedBadgeIds', failedBadgeIds);
  ...
  console.log('perPlayerEarned 2', perPlayerEarned);
