...
const searchForEarnedAchievements = async ({ scorecardId, results, courseId, layout, scorecard }) => {
  console.log('searchForEarnedAchievements', courseId);
  ...
  console.log('courseAchievementDefs', courseAchievementDefs);
          ...
          updateOne: {
            ...
            update: {
              $set: {
                ...
                ...(streakSatisfied ? { won: true, completed: true } : { completed: false }),
                updatedAt: new Date(),
                lastProgressAt: new Date(),
                ...(streakSatisfied ? { lastEarnedAt: new Date(), wonAt: new Date() } : {})
              },
              $setOnInsert: {
                userId: normalizedPlayerId,
                achievementId,
