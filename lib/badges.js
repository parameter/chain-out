...
=======
  const badgesRequiringHistory = badgeDefinitions.filter(badge => 
    badge.requiresHistoricalData === true || 
    (typeof badge.condition === 'string' && badge.condition.includes('historicalScorecards'))
  );
>>>>>>> 5fd2625eaeaa08aa4065bd522b9355d34b8b2952
