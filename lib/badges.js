...
const executeBadgeCondition = (badgeDef, playerResults, layout, courseId) => {
  ...
  try {
    ...
    if (typeof badgeDef.condition === 'string') {
      ...
      console.log('executeBadgeCondition badgeDef.condition: ', badgeDef.condition);

      console.log('executeBadgeCondition playerResults: ', playerResults);
      console.log('executeBadgeCondition layout: ', layout);
      console.log('executeBadgeCondition courseId: ', courseId);
