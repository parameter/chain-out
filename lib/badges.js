...
const updateBadgeProgress = async (userId, progressData, badgeDefinitions, courseId, layoutId) => {
  ...
  console.log('finding existing badgeprogress for: ', userId, badgeDef._id);
  ...
  if (existingProgress) {
    ...
    console.log('existing badgeprogress found for badge: ', badgeDef.name);
    ...
    console.log('progressData.progress', progressData.progress);
    ...
    let updateQuery = { userId: userId, _id: new ObjectId(progressData._id) };
    ...
    console.log('creatig new badgeprogress 1');
    ...
    console.log('creatig new badgeprogress 2');
