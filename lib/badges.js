...
const fetchEarnedBadgesForScorecard = async ({ scorecardId, results, courseId, layout, scorecard }) => {
  const db = getDatabase();
  const badgesCollection = db.collection('userBadgeProgress');
  ...
  console.log('badgesPerPLayer', badgesPerPLayer);
