...
const getBadgeDefinitions = async (db) => {
  console.log('getBadgeDefinitions ');
...
const searchForEarnedBadges = async (scorecardInput) => {
  ...
  console.log('badgeDefinitions ', badgeDefinitions);
  ...
  for (const playerIdStr of uniquePlayerIds) {
    ...
    console.log('earnedForPlayer ', earnedForPlayer);
    console.log('progressForPlayer ', progressForPlayer);
...
const executeBadgeCondition = (badgeDef, playerResults, layout) => {
  ...
  console.log('executeBadgeCondition badgeDef ', badgeDef);
  ...
  try {
    ...
    if (typeof badgeDef.condition === 'function') {
      console.log('badgeDef.condition', badgeDef.condition);
